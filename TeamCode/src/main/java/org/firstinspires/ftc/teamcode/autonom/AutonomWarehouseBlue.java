...
//@Disabled
@Autonomous(name = "Autonom Warehouse Blue", group = "autonom")
public class AutonomWarehouseBlue extends LinearOpMode {
...
//                .addTemporalMarker(2, () -> robot.maturica.collect())
                .splineToLinearHeading(new Pose2d(15, 64.5, Math.toRadians(184)), Math.toRadians(0), velocityConstraint(27), accelerationConstraint())
...
//                .addTemporalMarker(2, () -> robot.maturica.collect())
                .lineToLinearHeading(new Pose2d(14, 64.5, Math.toRadians(184)), velocityConstraint(26), accelerationConstraint())
                .addDisplacementMarker(() -> sensor_on.set(true))
                .addDisplacementMarker(() -> robot.maturica.collect())
                .lineToConstantHeading(new Vector2d(50, 67), velocityConstraint(vv), accelerationConstraint(33))
                .build();
...
//                .splineToLinearHeading(new Pose2d(3.5, -51, Math.toRadians(120 - 2.5 * id)), Math.toRadians(120), velocityConstraint(vv), accelerationConstraint())
                .splineToSplineHeading(new Pose2d(15, 66, Math.toRadians(176)), Math.toRadians(180), velocityConstraint(vv), accelerationConstraint())
                .splineToSplineHeading(new Pose2d(3.5, 50, Math.toRadians(-120 + 2.5 * id)), Math.toRadians(-120), velocityConstraint(vv), accelerationConstraint())
                .build();
    ...
    public void park_robot() {
        park = drive.trajectorySequenceBuilder(drive.getPoseEstimate())
                .addTemporalMarker(0.5, () -> robot.cupa.collect())
                .addTemporalMarker(1, () -> robot.glisiere.setToPosition(0))
                .splineToLinearHeading(new Pose2d(15, 64, Math.toRadians(184)), Math.toRadians(0), velocityConstraint(25), accelerationConstraint())
//                .addDisplacementMarker(() -> robot.maturica.collect())
                .addDisplacementMarker(() -> sensor_on.set(true))
